...
# oauth-tty Rakefile v7.0.0 - 2026-06-14
...
# rake install                                # Build and install oauth-tty-1.0.0.gem in...
# rake install:local                          # Build and install oauth-tty-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template oauth-tty against itse...
