...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/oauth/tty/version.rb", mod) }::OAuth::TTY::Version::VERSION
  else
    require_relative "lib/oauth/tty/version"
    OAuth::TTY::Version::VERSION
  end
...
Gem::Specification.new do |spec|
  ...
  spec.metadata["homepage_uri"] = "https://oauth-tty.galtzo.com"
